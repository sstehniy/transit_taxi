  ...
  <div class="create-order-container">
    ...
    <simplebar class="scrollable-form" data-simplebar-auto-hide="false">
      ...
      <div class="form-section">
        ...
        <div class="form-field">
          <div class="form-input extended" :class="{'invalid': validationErrors.origin}">
            ...
            />
            <img alt="pinpoint" id="pinpoint" :src="require('@/assets/pinpoint-icon.svg')" />
          ...
          <div class="form-input extended" :class="{'invalid': validationErrors.destination}">
            <input
              type="text"
              name="destitation"
      ...
      <div class="form-section">
        ...
        <div class="form-field">
          <div class="form-input extended" :class="{'invalid': validationErrors.crewGroup}">
            <p
        ...
        <div class="form-field">
          <div class="form-input extended" :class="{'invalid': validationErrors.crew}">
            ...
            />
            <FormDropdownSelect v-if="showCrews" :options="getCrews" @select-option="setCrew" />
          </div>
        </div>
        <div class="form-section-controls">
      ...
      <div class="form-section">
        ...
        <div class="form-field">
          <div class="form-input extended" :class="{'invalid': validationErrors.tariff}">
            <p @click="toggleTariffsDropdown">{{tariff.id? tariff.title: "Выберите тариф"}}</p>
            <img
              alt="drop"
              id="drop"
              :src="require('@/assets/drop-icon.svg')"
      ...
      <div class="form-section">
        ...
        <div class="form-field">
          <div class="form-input extended" :class="{'invalid': validationErrors.orderState}">
            <p
      ...
      <div class="form-section">
        ...
        <div class="inline-fields-container">
          ...
          <div class="form-field inline">
            <img alt="calender-icon" id="calender" :src="require('@/assets/calender-icon.svg')" />
            <input
              type="text"
  ...
  methods: {
    ...
    submit() {
      ...
      const newOrder = {
        ...
        attributes: [...this.attributes, this.newAttribute].filter(
          attr => attr !== null
        ),
